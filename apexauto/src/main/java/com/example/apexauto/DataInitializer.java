    ...
    private void seedVehicles() {
        ...
        List<CreateVehicleDTO> defaults = List.of(
                ...
                dto(
                        ...
                        4, 5, 85.0, 6.2, 459.0,
                        false, 3, "Sedan", new BigDecimal("89900.00")
                ),
                ...
                dto(
                        ...
                        2, 4, 165.0, 9.8, 340.0,
                        false, 2, "Sports", new BigDecimal("134500.00")
                ),
                ...
                dto(
                        ...
                        4, 7, 130.0, 8.4, 370.0,
                        false, 5, "SUV", new BigDecimal("74900.00")
                ),
                ...
                dto(
                        ...
                        4, 5, 77.0, 4.6, 402.0,
                        false, 4, "Sports", new BigDecimal("58900.00")
                ),
                dto(
                        "Halcyon", "Halcyon", "Volen Lumen", 2024, "Pearl White",
                        4, 5, 90.0, 3.9, 512.0,
                        false, 2, "Luxury", new BigDecimal("74500.00")
                ),
                dto(
                        "Meridian", "Meridian", "Meridian Bolt", 2023, "Graphite",
                        4, 5, 64.0, 5.4, 389.0,
                        true, 9, "Sedan", new BigDecimal("44900.00")
                )
        );
